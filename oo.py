#testดึงข้อมูลจากฐานข้อมูลมาแสดง ที่มีในreviews_historyของfujikathailand
...
conn.close()
print(df_focus_fujikathailand.head())
print(f"มีข้อมูลทั้งหมดคือ {len(df_focus_fujikathailand)} รายการ")


# ข้อมูลจากฐานข้อมูลมาแสดง ที่มีในreviews_historyของfujikathailand
